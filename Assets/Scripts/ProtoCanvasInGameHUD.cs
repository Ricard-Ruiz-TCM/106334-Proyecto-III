...
public class ProtoCanvasInGameHUD : MonoBehaviour {
    ...
    void Update() {
        ...
        string str = "HP: " + _actor.Health() +
            "\nDef: " + _actor.Defense() +
            "\nW: " + (_actor.Weapon() != null ? _actor.Weapon()._item.ToString() : " X ") +
            "\nS: " + (_actor.Shield() != null ? _actor.Shield()._item.ToString() : " X ") +
            "\nA: " + (_actor.Armor() != null ? _actor.Armor()._item.ToString() : " X ") +
            "";
